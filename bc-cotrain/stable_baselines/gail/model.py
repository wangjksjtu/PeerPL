...
class GAIL(TRPO):
    ...
    def __init__(self, policy, env, expert_dataset=None, hidden_size_adversary=100,
                 adversary_entcoeff=1e-3, g_step=3, d_step=1, d_stepsize=3e-4, verbose=0,
    ...
    def learn(self, total_timesteps, callback=None, log_interval=100, tb_log_name="GAIL",
              total_iters=None, reset_num_timesteps=True):
